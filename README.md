...
最终报告文件（以“第三次修改版”为最终提交报告）：

- `report/计算机设计实践最终实验报告-黄宇轩-第三次修改版.docx`
- `report/计算机设计实践最终实验报告-黄宇轩-第三次修改版.pdf`
- `report/计算机设计实践最终实验报告-黄宇轩-第二次修改版.docx`
- `report/计算机设计实践最终实验报告-黄宇轩-第二次修改版.pdf`
- `report/计算机设计实践最终实验报告-黄宇轩-最终提交版.docx`
- `report/计算机设计实践最终实验报告-黄宇轩-最终提交版.pdf`

报告中包含老师要求的四组测试截图、开发板照片、问题回答、关键代码片段和 diff 截图。
